...
final class Version20250203020051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cancion (id INT AUTO_INCREMENT NOT NULL, genero_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, duracion INT NOT NULL,archivo VARCHAR(255) DEFAULT NULL ,portada VARCHAR(255) DEFAULT NULL,album VARCHAR(255) DEFAULT NULL, autor VARCHAR(255) NOT NULL, likes INT NOT NULL, INDEX IDX_E4620FA0BCE7B795 (genero_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE playlist (id INT AUTO_INCREMENT NOT NULL, usuario_propietario_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, visibilidad VARCHAR(20) NOT NULL, likes INT NOT NULL, portada VARCHAR(255) DEFAULT NULL, INDEX IDX_D782112D32559FE1 (usuario_propietario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
